...
export default function ModalForCheckIn() {
  ...
  const timezone = 'Asia/Colombo';const dateFormat = 'YYYY-MM-DD HH:mm:ss';
  const convertedCheckInDate = moment.tz(checkInDateFromCalendar, timezone).format(dateFormat);console.log(convertedCheckInDate)
  const checkOutDateFromCalendar = checkInDate;
  const convertedCheckOutDate = moment.tz(checkOutDateFromCalendar, timezone).format(dateFormat);console.log(convertedCheckOutDate)
      ...
      <div className="card flex justify-content-center w-50rem">
        ...
        >
          ...
          <form onSubmit={handleSubmit} method="POST" action={""}>
            <div class="card">
              ...
              <div class="formgrid grid">
                <div class="field col-12 md:col-4 text-sm">
                  <label htmlFor="stayingPeriod">Staying Period</label>
                    ...
                    <Calendar value={checkInDate}
                              ...
                              showIcon={true} readOnlyInput required/>
                ...
                <div class="field col-12 md:col-4 text-sm">
                  ...
                  <select value={stayType} onChange={handleStayTypeChange}>
                ...
                <div class="field col-12 md:col-4 text-sm">
                  ...
                  <select value={roomNo} onChange={handleRoomNoChange}>
                    {roomNos.map((roomNo) => (
            ...
            <Button type="submit"  footer={footerContent} label="Check-in" size="small" onClick={(handleSubmit) => setVisible(false)} autoFocus/>
          </form>
        </Dialog>
      </div>
  );
